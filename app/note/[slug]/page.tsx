...
import type { NotePublicMeta, PublicAttachmentMeta, ViewWatermark } from '@/lib/types'
...
export default function NoteViewerPage() {
  ...
  const reveal = useCallback(async (key: string | undefined) => {
    setErrorMsg('')
    try {

        ...
        <div className="space-y-8 text-sm leading-relaxed">
          <section>
            ...
            <p className="text-base-muted">
              ...
              a view count, and a hashed ownership token â€” nothing else. We do not require or
          ...
          <section>
            ...
            <p className="text-base-muted">
              ...
              passphrase itself â€” meaning we cannot decrypt that note without it either.
          ...
          <section>
            ...
            <p className="text-base-muted">
              Every note is stored with an expiration you choose â€” from a few minutes up to
          ...
          <section>
            ...
            <p className="text-base-muted">
              ...
              in your browser and is never transmitted to us as a data set â€” clearing your
